...
- Tabbed shadcn inspector panes for overview metadata, port checks, and provisioning/dev logs, with a sheet-backed compact inspector path for narrow viewports.
